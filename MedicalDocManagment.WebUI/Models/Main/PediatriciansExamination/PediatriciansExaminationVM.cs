...
{
    public class PediatriciansExaminationVM
    {
        ...
        public PregnancyDetailsVM PregnancyDetails { get; set; }
        public BirthDetailsVM BirthDetails { get; set; }
        ...
        public PsychomotorDevelopmentVM PsychomotorDevelopmentOnFirstYear { get; set; }
